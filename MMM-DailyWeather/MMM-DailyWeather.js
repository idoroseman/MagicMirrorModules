...
Module.register("MMM-DailyWeather",{
	...
	// Define required scripts.
	getStyles: function() {
		return ["weather-icons.css", "MMM-DailyWeather.css"];
	},
	...
	getDom: function() {
		...
		if (this.config.colored) {
			...
			row2.className = "colored";
			row3.className = "colored";
			row4.className = "colored";
		}
		...
		for (var f in this.forecast) {
			...
			var avgTempCell = document.createElement("td");
			avgTempCell.innerHTML = forecast.avgTemp + degreeLabel;
			avgTempCell.className = "bright max-temp";
			row3.appendChild(avgTempCell);
	...
	processWeather: function(data) {
		...
		for (var i = 0, count = data.list.length; i < count; i++) {
			...
			var hour = moment(forecast.dt, "X").format("LT");
			...
			var forecastData = {
					...
					avgTemp: this.roundValue((forecast.temp.min + forecast.temp.max)/2),
